...
MASTER_A_ID=$(docker exec master-A redis-cli CLUSTER MYID)
MASTER_B_ID=$(docker exec master-B redis-cli CLUSTER MYID)
MASTER_C_ID=$(docker exec master-C redis-cli CLUSTER MYID)
...
echo -e "\nWaiting 15 secs for cluster to stabilize...\n"
sleep 15
